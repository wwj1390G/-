...
/* GPIO通用设置 
 * 1、GPIOx:GPIOA~GPIOI.
 * 2、BITx:0X0000~0XFFFF,位设置,每个位代表一个IO,第0位代表Px0,第1位代表Px1,依次类推.比如0X0101,代表同时设置Px0和Px8.
 * 3、MODE:0~3;模式选择,0=>输入(系统复位默认状态);1=>普通输出;2=>复用功能;3=>模拟输入.
 * 4、OTYPE:0/1;输出类型选择,0=>推挽输出;1=>开漏输出.
 * 5、OSPEED:0~3;输出速度设置,0=>2Mhz;1=>25Mhz;2=>50Mhz;3=>100Mh. 
 * 6、PUPD:0~3:上下拉设置,0=>不带上下拉;1=>上拉;2=>下拉;3=>保留.
